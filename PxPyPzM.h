...
namespace ABCFit {
class PxPyPzM : virtual public CoordRepr {
public:
  ...
  InvDerivative(Coordinates p); // Derivative of this representation w.r.t.
                                // internal representation
  std::string name() const { return "PxPyPzM"; };
...
static CoordRepr *pxpypzm = new PxPyPzM();
static CoordRepr *internalRepresentation = pxpypzm;
} // namespace ABCFit
#endif
