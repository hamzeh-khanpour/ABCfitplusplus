...
#ifndef _INVMASSCONSTRAINT_
#define _INVMASSCONSTRAINT_
#include "PxPyPzE.h"
#include "constraint.h"

namespace ABCFit {

class InvMassConstraint : public Constraint {
public:
  InvMassConstraint(ListOfParticleObjects ListOfParticles,
  ...
  virtual std::string name() const { return "InvMassConstraint"; };
};
} // namespace ABCFit
#endif
