...
#ifndef _SUMECONSTRAINT_
#define _SUMECONSTRAINT_
#include "PxPyPzE.h"
#include "constraint.h"

namespace ABCFit {

class SumEConstraint : public Constraint {
public:
  SumEConstraint(ListOfParticleObjects ListOfParticles,
  ...
  virtual std::string name() const { return "SumEConstraint"; };
};
} // namespace ABCFit
#endif
