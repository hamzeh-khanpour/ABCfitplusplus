...
#ifndef _SUMPYCONSTRAINT_
#define _SUMPYCONSTRAINT_
#include "PxPyPzE.h"
#include "constraint.h"

namespace ABCFit {

class SumPyConstraint : public Constraint {
public:
  SumPyConstraint(ListOfParticleObjects ListOfParticles,
  ...
  virtual std::string name() const { return "SumPyConstraint"; };
};
} // namespace ABCFit
#endif
