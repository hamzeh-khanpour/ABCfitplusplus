...
public:
  ...
  void SetCoordinates(Coordinates coordinates); // Set coordinates in repr_input
  ...
  void FixParameter(unsigned int ipar) { if (ipar < m_FixParameter.size()) m_FixParameter[ipar] = true; };
  void ReleaseParameter(unsigned int ipar) { if (ipar < m_FixParameter.size()) m_FixParameter[ipar] = false; };
  bool IsParameterFixed(unsigned int ipar) { return (ipar<m_FixParameter.size() ? m_FixParameter[ipar] : true); };
