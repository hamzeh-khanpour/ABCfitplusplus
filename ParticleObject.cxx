...
namespace ABCFit {
  ...
  ParticleObject::ParticleObject(Coordinates coordinates, CoordRepr* repr_input) : m_Chi2Repr(internalRepresentation), m_Unmeasured(true) {
    setup(coordinates, repr_input);
  }

  ParticleObject::ParticleObject(Coordinates coordinates, CoordRepr* repr_input, CoordRepr* Chi2Repr) : m_Chi2Repr(Chi2Repr), m_Unmeasured(false) {
    setup(coordinates, repr_input);
  }
